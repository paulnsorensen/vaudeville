---
agent: claude -p --bare --dangerously-skip-permissions --strict-mcp-config --mcp-config '{"mcpServers":{}}' --settings '{"apiKeyHelper":"./scripts/claude-oauth-keyhelper.sh"}' --model claude-sonnet-4-6 --allowedTools Read,Bash
commands:
  - name: rule
